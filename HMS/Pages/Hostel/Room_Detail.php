...
<script>
	function 	getStData(key) {
		...
		if (this.readyState == 4 && this.status == 200) {
		 ...
		 xhttp.open("GET", "../../lib/HOS_Basic.php?key="+key, true);
		 xhttp.send();
	}


    function Redirect(key) {
       window.location="room_present.php?key="+key;
    }
    </script>
</head>
<body onload="getStData('')">
  ...
  <form method="post" action="student_delete.php" onkeypress="return event.keyCode != 13;">
    ...
    <a href="Room_available.php" class="btn btn-primary"><span class="glyphicon glyphicon-file pull-left"></span>&nbsp;&nbsp;Available Room</a> <!-- </span> -->
