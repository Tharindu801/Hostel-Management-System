...
<script>
	function 	getStData(key) {
     $.get("../../lib/HOS_Current.php?key="+key, function(data, status){
...
<body onload="getStData('')">
  ...
  <form method="get" action="student_delete.php" onkeypress="return event.keyCode != 13;">

<?php
    $var_value = $_SESSION['hosid'];
?>
  <input type="hidden" name="hosids" id="hosids" value="<?php echo $var_value; ?>">
    ...
    <a href="outofDate.php" class="btn btn-primary"><span class="glyphicon glyphicon-file pull-left"></span>&nbsp;&nbsp;Out of Date</a> <!-- </span> -->
     <a href="javascript:history.go(-1)" type="Back" class="btn btn-danger"><span class="glyphicon glyphicon-trash pull-left"></span>&nbsp;&nbsp;Back</a>
