...
<script>
	function 	getStData(key) {
     $.get("../../lib/WP_D.php?key="+key, function(data, status){
...
<body onload="getStData(<?php echo "'$searchTxt'"; ?>)">
  ...
  <form method="post" action="../../lib/STD_DeleteSet.php" onkeypress="return event.keyCode != 13;">
    ...
    <p align="center"><span class="pull-left"><input type="checkbox" name="selectall" id="selectall" />&nbsp;&nbsp;Select All</span>
     ...
     <a href="withoutpic.php" class="btn btn-warning"><span class="glyphicon glyphicon-circle-arrow-left pull-left"></span>&nbsp;&nbsp;Discard and go back</a>
     </p> 
    </div>
    </form>
    </div>
