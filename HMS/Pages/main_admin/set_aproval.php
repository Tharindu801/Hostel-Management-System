...
<body onload="getStData('')">
  ...
  <form method="post" action="../../lib/STD_ApproveSet.php" onkeypress="return event.keyCode != 13;">
    ...
    <p align="center"><span class="pull-left"><input type="checkbox" name="selectall" id="selectall" />&nbsp;&nbsp;Select All</span>
     <button type="submit" class="btn btn-success"><span class="glyphicon glyphicon-trash pull-left"></span>&nbsp;&nbsp;Approve selected Students</button>
