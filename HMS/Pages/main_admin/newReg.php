...
<script>
  function  getStData(key) {
     $.get("../../lib/STD_newReg.php?key="+key, function(data, status){
...
<body onload="getStData('')">
  ...
  <form method="post" action="" onkeypress="return event.keyCode != 13;"><br>
    ...
    <p align="center"><!-- <span class="btn-group"> --><a href="set_aproval.php" class="btn btn-success"><span class="glyphicon glyphicon-file pull-left"></span>&nbsp;&nbsp;Approve</a> 
    <a href="excel_Input.php" class="btn btn-primary"><span class="glyphicon glyphicon-file pull-left"></span>&nbsp;&nbsp;Add From excel/CSV</a> <!-- </span> -->
     <a href="new_regdlt.php" class="btn btn-danger"><span class="glyphicon glyphicon-trash pull-left"></span>&nbsp;&nbsp;Delete</a>
