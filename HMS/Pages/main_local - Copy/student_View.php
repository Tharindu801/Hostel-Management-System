        ...
        <div class="formnew">
          <div id="basic" class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                Gender:
                <div class="radio" style="padding: 50px 0px 0px 0px;">
                  <label>
            ...
            <div class="col-sm-3">
            <button type="submit" class="btn btn-success btn-block"><span class="glyphicon glyphicon-edit pull-left"></span>Edit</button>
            </div>
            <div class="col-sm-3"> <button type="reset" class="btn btn-danger btn-block"><span class="glyphicon glyphicon-trash pull-left"></span>Delete</button>
            </div>
            ...
            <div class="col-sm-3"><button type="button" class="btn btn-warning btn-block"><span class="glyphicon glyphicon-folder-open pull-left"></span>View Log File</button></div>
