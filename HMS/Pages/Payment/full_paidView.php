...
<script>
  function  getStData(key) {
     $.get("../../lib/PAY_FView.php?key="+key, function(data, status){
...
<body onload="getStData('')">
  ...
  <form method="post" action="student_delete.php" onkeypress="return event.keyCode != 13;">
    ...
    <p align="center"><a href="full_paidView.php" class="btn btn-success disabled"><span class="glyphicon glyphicon-ok pull-left"></span>&nbsp;&nbsp;Full Paid</a> 
    <a href="half_paidView.php" class="btn btn-warning"><span class="glyphicon glyphicon-unchecked pull-left"></span>&nbsp;&nbsp;Half Paid</a>
    <a href="haveto_paidView.php" class="btn btn-danger"><span class="glyphicon glyphicon-unchecked pull-left"></span>&nbsp;&nbsp;0 paye</a>
