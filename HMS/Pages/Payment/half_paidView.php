...
<script>
  function  getStData(key) {
     $.get("../../lib/PAY_Hview.php?key="+key, function(data, status){
...
<body onload="getStData('')">
  ...
  <form method="post" action="student_delete.php" onkeypress="return event.keyCode != 13;">
    ...
    <a href="half_paidView.php" class="btn btn-warning disabled"><span class="glyphicon glyphicon-unchecked pull-left"></span>&nbsp;&nbsp;Half Paid</a>
