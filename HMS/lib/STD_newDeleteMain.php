...
include('STD_Con.php');
//Query
	$sql = "SELECT reg_no, full_Name, year_of_study, faculty, course FROM new_student_detail WHERE full_Name LIKE '%".$key."%' OR reg_no LIKE '%".$key."%' OR faculty LIKE '%".$key."%' OR course LIKE '%".$key."%';";
